...
pub mod version_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn version(
            ...
            let path = http::uri::PathAndQuery::from_static("/version.VersionService/Version");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("version.VersionService", "Version"));
...
pub mod version_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/version.VersionService/Version" => {
                    ...
                    impl<T: VersionService> tonic::server::UnaryService<super::VersionRequest> for VersionSvc<T> {
    ...
    pub const SERVICE_NAME: &str = "version.VersionService";
